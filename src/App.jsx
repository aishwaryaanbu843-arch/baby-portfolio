    ...
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="section projects-section" id="projects">
          ...
          <div className="text-projects">{projects.slice(2).map(project => <article className="text-project reveal" key={project.name}><span>{project.number}</span><h3>{project.name}</h3><p>{project.copy}</p>{project.github && <a className="text-project-link" href={project.github} target="_blank" rel="noreferrer">GitHub ↗</a>}<i>↗</i></article>)}</div>
        </section>
        ...
        <section className="proof-section" id="proof"><div className="section proof-inner"><div className="section-top"><span className="section-number">05</span><span className="eyebrow">Proof</span><span className="section-rule" /></div><div className="proof-heading reveal"><h2>Work, <em>documented.</em></h2><p>Real project, internship and certificate evidence from the portfolio archive.</p></div><div className="proof-grid">{proofImages.map(image => <button className="proof-card reveal" key={image.src} onClick={() => { setSelectedImage(image); setLightboxOpen(true) }}><img src={image.src} alt={image.alt} loading="lazy" /><span>Open proof ↗</span></button>)}</div></div></section>

        <section className="contact-section" id="contact"><div className="contact-inner"><div className="section-top"><span className="section-number">06</span><span className="eyebrow">Contact</span><span className="section-rule" /></div><p className="contact-kicker">Have an idea, opportunity or project in mind? Let's connect.</p><h2>Let's create<br /><i>something.</i></h2><div className="contact-links"><a href="mailto:bhuvanesh1102006@gmail.com">Email <span>bhuvanesh1102006@gmail.com ↗</span></a><a href="https://linkedin.com/in/bhuvanesh1102006" target="_blank" rel="noreferrer">LinkedIn <span>linkedin.com/in/bhuvanesh1102006 ↗</span></a><a href="https://github.com/Bhuvanesh0097" target="_blank" rel="noreferrer">GitHub <span>github.com/Bhuvanesh0097 ↗</span></a></div><div className="contact-bottom"><span>Open to conversations</span><span>Based in India · Available remotely</span></div></div></section>
      </main>
